...
function displayInscription ($affichage) {
    switch ($affichage) {
        ...
        default : 
            ...
            echo '
                <!--INSCRIPTION-->
                <form id="Inscription" class="Identification" method="post" action="inscription-inc.php">
                    <label>
                    ...
                    <label>
                        <input type="radio" class="CGU" name="choice" value="oui" required/> J\'ai lu et j\'accepte les <a class="link_CGU" href=#popup_CGU>mentions légales & CGU </a>
                    </label>
